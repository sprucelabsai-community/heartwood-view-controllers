...
const toolBeltToolSchema: SpruceSchemas.HeartwoodViewControllers.v2021_02_11.ToolBeltToolSchema  = {
	id: 'toolBeltTool',
	version: 'v2021_02_11',
...
SchemaRegistry.getInstance().trackSchema(toolBeltToolSchema)

export default toolBeltToolSchema
