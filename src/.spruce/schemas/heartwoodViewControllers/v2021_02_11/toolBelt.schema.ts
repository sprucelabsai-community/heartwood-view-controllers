...
import toolBeltToolSchema_v2021_02_11 from '#spruce/schemas/heartwoodViewControllers/v2021_02_11/toolBeltTool.schema'

const toolBeltSchema: SpruceSchemas.HeartwoodViewControllers.v2021_02_11.ToolBeltSchema  = {
	id: 'toolBelt',
	version: 'v2021_02_11',
	...
	moduleToImportFromWhenRemote: '@sprucelabs/heartwood-view-controllers',
	    fields: {
	            ...
	            'tools': {
	                ...
	                isRequired: true,
	                isArray: true,
	                options: {schema: toolBeltToolSchema_v2021_02_11,}
	            },
	    }
}

SchemaRegistry.getInstance().trackSchema(toolBeltSchema)

export default toolBeltSchema
