...
const inputButtonSchema: SpruceSchemas.HeartwoodViewControllers.v2021_02_11.InputButtonSchema  = {
	id: 'inputButton',
	version: 'v2021_02_11',
...
SchemaRegistry.getInstance().trackSchema(inputButtonSchema)

export default inputButtonSchema
