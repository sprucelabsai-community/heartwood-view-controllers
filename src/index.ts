...
export { default as LoginViewController } from './viewControllers/login/Login.vc'
...
export { default as ConfirmJoinCardViewController } from './viewControllers/login/ConfirmJoinCard.vc'
export * from './viewControllers/login/ConfirmJoinCard.vc'
